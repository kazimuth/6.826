...
Fixpoint oddmembers (l:natlist) : natlist :=
  match l with
  | nil => nil
  | n :: rest => match odd n with
               | true => n :: oddmembers rest
...
Fixpoint alternate (l1 l2 : natlist) : natlist :=
  match l1 with
  | nil => l2
  | h1 :: rest1 => h1 :: match l2 with
                      | nil => rest1
                      | h2 :: rest2 => h2 :: (alternate rest1 rest2)
                      end
  end.
...
Theorem bag_theorem : forall l:natlist, forall v:nat,
        count v (add v l) = S (count v l).
Proof.
  intros l v. destruct l as [| head rest Ihrest].
  - simpl. rewrite <- beq_nat_refl. reflexivity.
  - simpl. rewrite <- beq_nat_refl. simpl. reflexivity.
Qed.
...
Theorem app_nil_r : forall l : natlist,
  l ++ [] = l.
Proof.
  induction l as [| h rest Ihrest].
  - reflexivity.
  - simpl. rewrite -> Ihrest. reflexivity. Qed.
...
Proof.
  intros l1 l2. induction l1 as [|h1 rest1 Ih1].
  - reflexivity.
  - simpl. rewrite Ih1. destruct h1.
    + reflexivity.
    + simpl. reflexivity.
Qed.
...
Fixpoint beq_natlist (l1 l2 : natlist) : bool :=
  ...
  | h1 :: rest1 => match l2 with
                 | h2 :: rest2 => andb (beq_nat h1 h2) (beq_natlist rest1 rest2)
                 | nil => false
                 end
  | nil => match l2 with
          | nil => true
